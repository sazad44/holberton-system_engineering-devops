...
:fire:![IsItDown Logo](https://github.com/sazad44/holberton-system_engineering-devops/blob/master/0x19-postmortem/isitdownlogo?raw=true) :fire:
:fire::fire::fire::fire::fire::fire:
...
Estimated 565M queries lost, $1B of ad revenue foregone or requested back by
companies whose ads were unable to be seen.
